...
export const RISK_GRADING_OPTIONS = [
  { value: "Low", label: "Low" },
...
export const LEVEL_OF_INVESTIGATION_OPTIONS = [
...
export interface DeathReportPagination {
  currentPage: number;
  pageSize: number;
  totalItems: number;
  totalPages: number;
...
export interface DeathReportsResponse {
  deathReports: {
    data: DeathReport[];
    pagination: DeathReportPagination;
  };
}

export interface DeathReportsSearchResponse {
