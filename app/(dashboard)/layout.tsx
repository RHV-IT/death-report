...
function getNavItems(pathname: string): NavigationItem[] {
  return [
    ...
    {
      label: "View Death Reports",
      href: "/dashboard/death-reports",
      icon: ClipboardList,
      variant: pathname === "/dashboard/death-reports" ? "default" : "ghost",
    },
    {
      ...
      >
        <div className="flex h-14 items-center border-b px-4">
          <Link href="/dashboard" className="flex items-center gap-2 font-semibold">
            ...
            {sidebarOpen && <span className="font-bold text-primary transition-opacity duration-200">DeathReport</span>}
          </Link>
        </div>
